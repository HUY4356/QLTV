...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BanTheSa__3213E83FEAD35BAE");

            entity.ToTable("BanTheSach");

            entity.HasIndex(e => e.MaVach, "UQ__BanTheSa__8BBF4A1C073D7B38").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BaoCaoVo__3213E83FA77E003F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BoSungTa__3213E83F88986B3B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__DanhMucS__3213E83FDE1C52F3");
            ...
            entity.HasIndex(e => e.MaSach, "UQ__DanhMucS__B235742C87779AA9").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__DatPhong__3213E83F0A06CA64");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__DatTruoc__3213E83F14A4126A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__HanMuc__3213E83F2C7519F0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__MuonTra__3213E83FAEC29C72");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__NhomSach__3213E83F526C8F8E");

            entity.ToTable("NhomSach");

            entity.HasIndex(e => e.MaNhom, "UQ__NhomSach__234F91CC83B97502").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Phong__3213E83FCC3C40F6");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Role__3213E83F423E648B");

            entity.ToTable("Role");

            entity.HasIndex(e => e.Name, "UQ__Role__72E12F1BD6FC58A0").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ThamSoHe__3213E83FE9DD7CD5");

            entity.ToTable("ThamSoHeThong");

            entity.HasIndex(e => e.Ten, "UQ__ThamSoHe__C451FA833E7B1BA0").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__The__3213E83FFE540A3F");

            entity.ToTable("The");

            entity.HasIndex(e => e.TheCode, "UQ__The__F4DC1159BAF41F33").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__User__3213E83F71218530");

            entity.ToTable("User");

            entity.HasIndex(e => e.Email, "UQ__User__AB6E61646113106A").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ViPhamUs__3213E83FDF12A0ED");
