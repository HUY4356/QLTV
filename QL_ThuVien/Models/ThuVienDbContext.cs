...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BanTheSa__3213E83F3E90391A");

            entity.ToTable("BanTheSach");

            entity.HasIndex(e => e.MaVach, "UQ__BanTheSa__8BBF4A1C89AF509C").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BaoCaoVo__3213E83F69E3741C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BoSungTa__3213E83F500B5D74");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__DanhMucS__3213E83FB6787022");
            ...
            entity.HasIndex(e => e.MaSach, "UQ__DanhMucS__B235742CC8E20626").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__DatPhong__3213E83FC5F75D1C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__DatTruoc__3213E83FB79AF20C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__HanMuc__3213E83F9A637762");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__MuonTra__3213E83F4EBD3E05");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__NhomSach__3213E83F84D9BDA2");

            entity.ToTable("NhomSach");

            entity.HasIndex(e => e.MaNhom, "UQ__NhomSach__234F91CC3433330A").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Phong__3213E83F1E5897BD");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Role__3213E83F57E0A216");

            entity.ToTable("Role");

            entity.HasIndex(e => e.Name, "UQ__Role__72E12F1B1B367A4C").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ThamSoHe__3213E83F960FBF6C");

            entity.ToTable("ThamSoHeThong");

            entity.HasIndex(e => e.Ten, "UQ__ThamSoHe__C451FA83FE0DAE95").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__The__3213E83FCD1F096B");

            entity.ToTable("The");

            entity.HasIndex(e => e.TheCode, "UQ__The__F4DC115964E3FE9F").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__User__3213E83F40D53B79");

            entity.ToTable("User");

            entity.HasIndex(e => e.Email, "UQ__User__AB6E61646CC6BE4C").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ViPhamUs__3213E83F0493DB6E");
